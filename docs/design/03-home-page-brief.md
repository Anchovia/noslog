...
container's available width. If content pressure remains, adjust gaps, padding, shared
block height, or the approved `nav-fit` `12/16` compact fit step defined in `HOME-21`,
and use label wrapping only after those; do not use ellipsis and do not reduce a
destination label below the `nav-fit` step.
...
- Keep all eight blocks equal in width and visual weight. Block width, height, and
  surface stay identical; the `HOME-21` fit step may render an individual label at
  `12/16` without changing block geometry. A localized label may wrap without clipping
  or truncation, but wrapping is the final fallback after the fit step and approved
  concise wording; let the shared row height accommodate the longest required label
  rather than shrinking text below the `nav-fit` step.
...
| HOME-20 | Adaptive destination geometry           | Use eight equal peers as `3 × 3` below the validated compact content width and `4 × 2` when sufficient width is available; keep the final compact row source ordered and unstretched, start destination labels at 14px `control`, and use concise localized labels without ellipsis. Amended by `HOME-21` for the compact fit step.                                                                  | `Approved`              |
| HOME-21 | Compact destination label fit           | Amends `HOME-20`: destination tiles use a `12` inset; a label starts at `control 14/20`, drops to the `nav-fit` `12/16` step when its measured compact cell cannot hold it, then uses approved concise wording, and only then wraps to two lines. Restore `14/20` as soon as the measured cell fits. Approved concise additions: Korean `동기화` for Data Sync and Japanese `譜面` for Chart Viewer. | `Approved — 2026-08-18` |
...
On 2026-08-18 the user approved `HOME-21` after reviewing measured Korean, Japanese, and
English label widths at `320px` and `390px`. Two lines were rejected as the compact
default because Japanese broke mid-word, and narrowing the tile inset to `8` was rejected
as visually cramped. The `12/16` fit step, previously scoped to the DestinationPanel, now
also serves the Home destination collection; see `15-shared-shell-navigation-brief.md`.
...
### Decision Log addendum — 2026-09-04 (AI-generic check, decision ②)

| ID        | Decision                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `HOME-22` | **Destination tiles are horizontal: icon 20 + label side by side.** Compact (<672): 2 columns, tile 173×44 (inset 12, gap 8, gutter 12), 4 rows; 320: 2 columns 138×44; Intermediate 768/1024: 4×2 with inset 12; Wide 1280: 4×2 with inset 24 (292×68). Replaces the icon-over-label 111×72 / 292×96 tiles of `HOME-21`. Two independent reviews (this file's slop-rule scan and a Codex cross-check) named the icon-over-label equal-tile grid as the most generic surface in the product — the shape the AI-slop catalogues call the "feature-card template". The tile face, `surface/surface` + radius 8, the fit cascade (`control → nav-fit → approved abbreviation → wrap`) and `HOME-21`'s abbreviations are unchanged; with the wider label cell every locale now fits at `control 14/20` at all widths (424 tiles measured, nav-fit 0, wrap 0). Zone height 228 → 212 at 390, so the keyboard-state dynamic row count keeps its worst case. |

### Decision Log addendum — 2026-09-06 · `HOME-23` (supersedes `HOME-22`)

| ID        | Decision                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `HOME-23` | **Destination tiles return to icon-over-label, and on wide widths the grid is bounded to the search field.** User decision after living with `HOME-22`: the wide, short horizontal rows are harder to scan than the 1.0 grid. Compact (<672): **3 columns**, tile `(content − 2×12) / 3` wide (390: 111, 320: 88) × 72 (inset 12, icon 20, gap 8, label 20), gutter 12, rows 3 · 3 · 2 with the short row left-aligned. Intermediate and Wide (≥672): the grid sits inside the same **640 bounded column** as the identity and search (`HOME-21`'s Wide 1280 A안 block), **4 columns** of 148 × 96 (inset 24), gutter 16 — no longer the full 1216. Face, fit cascade and abbreviations unchanged (`HOME-21`); 456 tiles measured: control 453 · nav-fit 3 (320 JA/EN) · abbreviation 0 · wrap 0. `HOME-22`'s slop-catalogue argument is acknowledged and overruled by use. |

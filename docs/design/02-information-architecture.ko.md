...
- **확정:** 공식 소식은 핵심 검색·이동·데이터 연동 과업 다음에 오는 홈의
  낮은 우선순위 편집 콘텐츠로 유지합니다. 정확한 표시 방식은 홈 페이지
  기획서에서 결정합니다.
...
| ------------------ | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| 진입 및 방향 파악  | “어디로 이동하고 어떤 정보를 즉시 확인할 수 있는가?”           | 홈, 공지, 전역 악곡 검색, 직접 이동 블록, 공식 소식, 피드백 진입                                                                | 주요 진입 및 이동 허브                              |
...
5. **편집 콘텐츠:** 공식 소식은 핵심 제품 과업 다음에 유지합니다.
...
- **공식 소식:** 제거하지 않습니다. 과업 중심 홈 계층 다음의 편집 콘텐츠로
  유지합니다. 전체 X Embed, 최신 소식 요약 및 간결한 공식 채널 링크를 홈
  페이지 기획서에서 비교한 뒤 표시 방식을 결정합니다.

정확한 블록 비율과 순서는 홈 페이지 기획서 승인 전까지 미확정입니다.
...
| IA-07 | 공식 소식 위치             | 핵심 제품 과업 다음의 홈 편집 콘텐츠, 정확한 표시 방식은 홈 페이지 기획서에서 결정                                           | `승인` |
...
이 문서의 중요한 정보 구조 결정은 모두 해결되었습니다. 사용자가 동기화된
영어·한국어 문서 전체를 검토하고 이 단계를 명시적으로 승인하기 전까지 문서
상태는 `논의용 초안`으로 유지합니다. 시각 구성, 정확한 반응형 순서 및 페이지
고유 상태는 미확정 정보 구조 문제가 아니라 페이지 기획서 결정입니다.
...
1. 영어·한국어 정보 구조 문서를 사용자와 검토합니다.
2. 사용자가 전체 단계를 명시적으로 승인한 뒤에만 문서를 승인 상태로
   변경합니다.
3. 승인 후 홈, 악곡 탐색, 악곡 상세, 서열, 나머지 페이지 패밀리 순서로
   페이지 기획서를 작성합니다.

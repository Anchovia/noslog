...
| [Approved IA](./02-information-architecture.md)                                                                                          | Keeps Bingo an independent Challenge destination linked to Music                                     | Preserves access and contextual Music links                                 | Does not define list/detail anatomy                                                     |

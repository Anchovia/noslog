...
### Decision Log addendum — 2026-09-07 · `SYNC-30` (Z1 ㉜)

| ID        | Decision                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `SYNC-30` | **First-use page is an install card, not a document.** The user compared the built page with the 1.0 site and found the text-led stack worse. Under `북마클릿 등록` the bookmarklet sits in a **dashed drop target** (`border/strong` 1 px dashed, radius 8, inset 16) inside a `surface/surface` card (inset 24), with the caption `이 버튼을 북마크바로 드래그하세요` centred beneath; the example GIF sits below in a framed 16:9 media slot (`surface/sunken` + `border/default`, 358 wide at 390, 640 on Wide); `모바일에서 등록하는 방법` collapses into a Disclosure. `기록 동기화` steps are numbered rows (24 px number disc + one sentence) with their GIF beside at ≥672 (320×180) and below at Compact. The security sentence moves from the top into `도움말 · 보안`. The heading `PC에서 등록하는 방법` is dropped. The status row of this state shows **`기록 없음` only** — `동기화한 적 없음` said the same thing twice (user edit on the specimen). Wide keeps `SYNC-26` 805/395 with the help column on the right. All copy is the existing catalog set; no new string. |

### Decision Log addendum — 2026-09-07 · `SYNC-31` (Z1 ㉝)

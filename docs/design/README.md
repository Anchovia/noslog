...
- **높이:** 컨트롤 `--nl-control-height` 44 (1056 이상 40) — 입력 · 셀렉트 · 검색 · 버튼 · 트리거 · 2단 탭.
  같은 줄 컨트롤은 높이가 같아야 한다. 1단 탭 48, 필터 칩 36.
  펼쳐지는 메뉴 · 목록 행(셀렉트 · 정렬 · 검정 목록 · 「⋯」 메뉴 · 레일 체크 목록 · 설정 오락실 목록)도 컨트롤 높이,
...
- **목록**(셀렉트 목록 · `SortMenu` · 좁은 셀렉트): 떠 있는 창 규격, 행 = 컨트롤 높이(폰 44 · 데스크톱 40) · 4 간격, 선택 = `menu-set` 면 + 600 + 오른쪽 체크 16.

...
| Dashboard composition | [`features/exams/components/examDashboard.tsx`](../../features/exams/components/examDashboard.tsx)                                                                                           | Replace client-only selection with URL contract; preserve one selected Exam; scope analysis/proof correctly                                     |
...
| Proof UI              | [`features/exams/components/examProofUpload.tsx`](../../features/exams/components/examProofUpload.tsx)                                                                                       | Add choose-preview-confirm, evidence checklist, complete state model, and accessible recovery                                                   |
...
| [Current Exam components](../../features/exams/components/examDashboard.tsx)                                        | Shows three modes, one selector, analysis, stages, and proof flow                                              | Identifies useful composition and current gaps                     | Immediate upload and Basic-only analysis are superseded            |

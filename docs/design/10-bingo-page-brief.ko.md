...
- 빙고 Surface에는 정본 원문 빙고판 및 악곡 제목을 표시합니다. 승인된 악곡
  번역·읽기는 검색 가능하게 유지하고 악곡 상세에서만 Disclosure로 제공합니다.
- 미션 지시 다국어는 악곡 상세의 번역 Disclosure와 독립적입니다.
...
- 악곡 제목 Disclosure는 다국어 미션 지시를 억제하지 않습니다.

...
| `REF-D02` | Treat this matrix as a cross-cutting source pool, not a substitute for focused twelve-to-fifteen-source decisions.                           | The approved research method requires relevant evidence saturation for each focused material decision.                                                                                                                                                                                                                                                                                                         | `Proposed` |
...
| `REF-D05` | Carry the ten principle candidates into user review before drafting foundation v0.1.                                                         | Required by the design-guide workflow and approval gates.                                                                                                                                                                                                                                                                                                                                                      | `Proposed` |

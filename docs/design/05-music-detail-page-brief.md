...
- A missing jacket uses the approved centered Lucide `music` fallback and the
  ...
  that empty-slot boundary. A missing player avatar is not covered here; it uses the
  username-initial fallback approved as `PROF-36` in document `09`.
...
| MDET-85 | Missing artwork fallback                        | Use the centered Lucide `music` fallback and `border/empty-slot` only while real jacket imagery is absent; avatar fallback moved to `PROF-36` on 2026-08-26                                                                                                                                                                                                                                                                                                             | `Approved — 2026-08-12/13`     |
...
### Decision Log addendum — 2026-09-06 (Z1 ㉕)

| ID      | Decision                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MDET-91 | **Contextual actions join the identity row at Intermediate and above.** `View chart` and `Play video` sit at the right end of the jacket/title row, hugging their labels (86 + 98, gap 8), vertically centred on the 96 px jacket; the artist line truncates to one line with an ellipsis. Below 768 the Compact form (a full-width two-up row under the identity) is unchanged. Rationale: at 1280 the Compact FILL rule stretched each button to 604 px — a width nobody derived; the identity row is the same place P6 keeps its owner actions; the header drops 152 → 96 so the difficulty selector rises into the first view. Threshold is the tier boundary, derived from fit: 192 for the actions plus ≥ 400 for the identity text fits from the 720 content width of 768. |

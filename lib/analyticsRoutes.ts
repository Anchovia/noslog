...
export const PAGE_ROUTES: readonly AnalyticsRoute[] = [
    ...
    { pattern: "/events", label: "이벤트" },
    { pattern: "/events/[id]", label: "이벤트 상세" },
    { pattern: "/events/new", label: "이벤트 글쓰기" },
    { pattern: "/events/mine", label: "내 이벤트 글" },
    { pattern: "/events/[id]/edit", label: "이벤트 고치기" },
